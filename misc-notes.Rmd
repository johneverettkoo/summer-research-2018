...
```{r proj_clust, fig.cap = '2D embedding annotated by cluster assignments. From right to left: k-means on the unscaled embedding, k-means on the scaled embedding, and k-means on the 1D embedding.', fig.height = 3}
two.eigen.df %<>% 
